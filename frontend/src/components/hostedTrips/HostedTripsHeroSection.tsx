...
export const HostedTripsHeroSection = () => {
  return (
    <section
      className="relative px-10 bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage: `linear-gradient(rgba(102, 126, 234, 0.8), rgba(147, 107, 230, 0.8)), url(${destinationsHeroBg})`,
      }}
    >
      <div className="container mx-auto text-center relative z-10 min-h-[260px] sm:min-h-[300px] flex flex-col justify-center py-16 sm:py-20">
