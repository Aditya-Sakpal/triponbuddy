...
export const WhyTriponBuddySection = () => {
  ...
  return (
    <section className="py-16 px-4 bg-blue-100/50 overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
        {/* Main Title */}
        <h2 className="text-4xl font-bold font-latin text-center mb-12 text-bula">
          ...
          {whyFeatures.map((feature, index) => (
            <div key={index} className="text-center">
              <div className="flex justify-center mb-4">
                <feature.icon className="w-8 h-8 text-bula" />
              </div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={() => navigate('/destinations')} className="bg-bula hover:bg-bula text-white px-6 py-2 font-latin">
